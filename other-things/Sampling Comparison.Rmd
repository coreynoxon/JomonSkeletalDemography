...
#```{r corr-posthole-mean-SD, cache=TRUE, cache.extra=tools::md5sum(here::here("04-06-correlation-analysis-matrices-posthole-mean-SD.R"))}
#suppressWarnings(source('04-06-correlation-analysis-matrices-posthole-mean-SD.R'))
#```

```{r corr-length-floor-space-posthole, cache=TRUE, cache.extra=tools::md5sum(here::here("4-07-correlation-analysis-pithouse-length-floor-space-to-postholes.R"))}
suppressWarnings(source('04-07-correlation-analysis-pithouse-length-floor-space-to-postholes.R'))
```

#```{r corr-main-mainwall, cache=TRUE, cache.extra=tools::md5sum(here::here("04-08-correlation-analysis-main-mainwall-comparison.R"))}
#suppressWarnings(source('04-08-correlation-analysis-main-mainwall-comparison.R'))
#```
...
```{r plots-growth, cache=TRUE, cache.extra=tools::md5sum(here::here("05-09-plots-growth-rates.R"))}
suppressWarnings(source('05-09-plots-growth-rates.R'))
```
