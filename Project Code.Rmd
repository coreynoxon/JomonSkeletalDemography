...
```{r extras, include=FALSE, cache=TRUE, cache.extra=tools::md5sum(here::here("06-extras.R"))}
suppressWarnings(source('06-extras.R'))
```

```{r tables, include=FALSE, cache=TRUE, cache.extra=tools::md5sum(here::here("05-tables.R"))}
suppressWarnings(source('05-tables.R'))
```
